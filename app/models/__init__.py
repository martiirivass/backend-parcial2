# Import all models so SQLModel registry resolves all relationships correctly.
# Without this, string-based Relationship references (e.g. "DireccionEntrega")
# fail because the target class hasn't been registered yet.
